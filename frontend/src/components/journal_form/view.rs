                                                ...
                                                <input
                                                    ...
                                                    onchange={ctx.link().callback(|e: Event| {
                                                        ...
                                                        if let Some(file) = files.get(0) {
                                                            ...
                                                            Msg::FetchError("ファイルが選択されていません".to_string())
                                                        }
                                                    })}
                                                />
                                                <button
                                                    type="button"
                                                    class="secondary"
                                                    onclick={ctx.link().callback(|_| Msg::ExtractReceiptStart)}
                                                    disabled={self.model.loading || self.model.selected_file.is_none()}
                                                >
                                                    {"AI仕訳作成"}
                                                </button>
                                            </div>
